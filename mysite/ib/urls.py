...
urlpatterns = [
    ...
    path('index9b', views.analisi_trade_scadenza_2),
    path('index45', views.analisi_trade_scadenza_PUTCALL),
    ...
    path('index96', views.analisi_di_portafoglio_2),
    path('index95', views.analisi_di_portafoglio_3),
    ...
    path('index39', views.analisi_dei_movimenti_anno_4),
    ...
    path('index99b', views.analisi_di_anno_2024),
